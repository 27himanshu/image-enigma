...
Using a maximum possible pairs of plugboard wires (128 pairs for an 8-bit image), We have (C(256,2) * C(254,2) * .... * C(2,2))/123! = 256!/(2^256 * 123!) = 6.099E+224
Total possible combinations ≈ 10^229 = 2^768, That is 768 bits.
